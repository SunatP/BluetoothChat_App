...
class ChatController(context: Context, private val handler: Handler) {
    ...
    companion object {
        ...
        internal val STATE_LISTEN = 1
        internal val STATE_CONNECTING = 2
        internal val STATE_CONNECTED = 3
    }
}